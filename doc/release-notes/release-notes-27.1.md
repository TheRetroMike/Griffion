Griffion Core version 27.0 is now available from:

  <https://griffion.org/bin/griffion-core-27.0/>
...
- A C++20 capable compiler is now required to build Griffion Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Griffion Core would
