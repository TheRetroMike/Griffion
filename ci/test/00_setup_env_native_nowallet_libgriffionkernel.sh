...
export CONTAINER_NAME=ci_native_nowallet_libgriffionkernel
...
export GOAL="install"
export GRIFFION_CONFIG="--enable-reduce-exports --enable-experimental-util-chainstate --with-experimental-kernel-lib --enable-shared"
