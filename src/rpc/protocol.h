...
#ifndef GRIFFION_RPC_PROTOCOL_H
#define GRIFFION_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in griffiond
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Griffion is not connected
