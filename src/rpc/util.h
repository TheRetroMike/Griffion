...
#ifndef GRIFFION_RPC_UTIL_H
#define GRIFFION_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting GRIFF/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1GRIFF/kvB.
 */
