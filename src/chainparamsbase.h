...
#ifndef GRIFFION_CHAINPARAMSBASE_H
#define GRIFFION_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between griffion-cli and griffiond)
 * of a given instance of the Griffion system.
 */
...
#endif // GRIFFION_CHAINPARAMSBASE_H
