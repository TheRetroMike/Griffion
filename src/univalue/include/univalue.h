...
// Copyright 2015 Griffion Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef GRIFFION_UNIVALUE_INCLUDE_UNIVALUE_H
#define GRIFFION_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // GRIFFION_UNIVALUE_INCLUDE_UNIVALUE_H
