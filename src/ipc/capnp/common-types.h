...
#ifndef GRIFFION_IPC_CAPNP_COMMON_TYPES_H
#define GRIFFION_IPC_CAPNP_COMMON_TYPES_H
...
//! Functions to serialize / deserialize common griffion types.
namespace mp {
...
#endif // GRIFFION_IPC_CAPNP_COMMON_TYPES_H
