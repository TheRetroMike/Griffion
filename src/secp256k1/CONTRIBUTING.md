...
The library primarily serves the needs of the Griffion Core project but provides additional functionality for the benefit of the wider Griffion ecosystem.
...
* **Relevance Arguments:**
    The relevance of the new functionality for the Griffion ecosystem should be argued by outlining clear use cases.
...
The Contributor Workflow & Peer Review in libsecp256k1 are similar to Griffion Core's workflow and review processes described in its [CONTRIBUTING.md](https://github.com/GriffionProject/Griffion/blob/master/CONTRIBUTING.md).
