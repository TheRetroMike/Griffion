...
#ifndef GRIFFION_WALLET_WALLETUTIL_H
#define GRIFFION_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! griffion from opening the wallet, thinking it was newly created, and
...
#endif // GRIFFION_WALLET_WALLETUTIL_H
