...
#ifndef GRIFFION_WALLET_WALLET_H
#define GRIFFION_WALLET_WALLET_H
...
public:
     ...
     * griffion-wallet tool code or by wallet migration code. If this is called
...
#endif // GRIFFION_WALLET_WALLET_H
