...
#ifndef GRIFFION_WALLET_SCRIPTPUBKEYMAN_H
#define GRIFFION_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Griffion Core wallet was originally a collection of unrelated private
...
#endif // GRIFFION_WALLET_SCRIPTPUBKEYMAN_H
