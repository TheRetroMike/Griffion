...
#ifndef GRIFFION_WALLET_TRANSACTION_H
#define GRIFFION_WALLET_TRANSACTION_H
...
public:
     ...
     * on this griffion node, and set to 0 for transactions that were created
...
#endif // GRIFFION_WALLET_TRANSACTION_H
