...
#ifndef GRIFFION_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define GRIFFION_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // GRIFFION_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
