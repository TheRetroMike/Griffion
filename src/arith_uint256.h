...
#ifndef GRIFFION_ARITH_UINT256_H
#define GRIFFION_ARITH_UINT256_H
...
public:
     ...
     *
     * Griffion only uses this "compact" format for encoding difficulty
...
#endif // GRIFFION_ARITH_UINT256_H
