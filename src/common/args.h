...
#ifndef GRIFFION_COMMON_ARGS_H
#define GRIFFION_COMMON_ARGS_H
...
extern const char * const GRIFFION_CONF_FILENAME;
extern const char * const GRIFFION_SETTINGS_FILENAME;
