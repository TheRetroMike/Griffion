...
//! @file
//! @brief Common init functions shared by griffion-node, griffion-wallet, etc.

#ifndef GRIFFION_INIT_COMMON_H
#define GRIFFION_INIT_COMMON_H
