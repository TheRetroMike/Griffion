...
const std::string GriffionGUI::DEFAULT_UIPLATFORM =
...
GriffionGUI::GriffionGUI(interfaces::Node& node, const PlatformStyle *_platformStyle, const NetworkStyle *networkStyle, QWidget *parent) :
    QMainWindow(parent),
    m_node(node),
    ...
    m_network_style(networkStyle)
{
    ...
    QFile defaultStylesheetFile(":/qss/default");
    if (defaultStylesheetFile.open(QFile::ReadOnly)) {
        QString defaultStylesheet = QString::fromUtf8(defaultStylesheetFile.readAll());
        qApp->setStyleSheet(defaultStylesheet);
        defaultStylesheetFile.close();
    }
    ...
    if(enableWallet)
    {
        ...
        connect(walletFrame, &WalletFrame::createWalletButtonClicked, this, &GriffionGUI::createWallet);
    ...
    connect(labelBlocksIcon, &GUIUtil::ClickableLabel::clicked, this, &GriffionGUI::showModalOverlay);
    connect(progressBar, &GUIUtil::ClickableProgressBar::clicked, this, &GriffionGUI::showModalOverlay);
...
void GriffionGUI::createActions()
{
    ...
    sendCoinsAction = new QAction(platformStyle->SingleColorIcon(":/icons/send", QColor(255,255,255)), tr("&Send"), this);
    sendCoinsAction->setStatusTip(tr("Send coins to a Griffion address"));
    sendCoinsAction->setToolTip(sendCoinsAction->statusTip());
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(QStringLiteral("Alt+2")));
    tabGroup->addAction(sendCoinsAction);

    receiveCoinsAction = new QAction(platformStyle->SingleColorIcon(":/icons/receiving_addresses", QColor(255,255,255)), tr("&Receive"), this);
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and griffion: URIs)"));
    receiveCoinsAction->setToolTip(receiveCoinsAction->statusTip());
    receiveCoinsAction->setCheckable(true);
    receiveCoinsAction->setShortcut(QKeySequence(QStringLiteral("Alt+3")));
    tabGroup->addAction(receiveCoinsAction);

    historyAction = new QAction(platformStyle->SingleColorIcon(":/icons/history", QColor(255,255,255)), tr("&Transactions"), this);
    ...
    connect(overviewAction, &QAction::triggered, this, &GriffionGUI::gotoOverviewPage);
    connect(sendCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(sendCoinsAction, &QAction::triggered, [this]{ gotoSendCoinsPage(); });
    connect(receiveCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(receiveCoinsAction, &QAction::triggered, this, &GriffionGUI::gotoReceiveCoinsPage);
    connect(historyAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(historyAction, &QAction::triggered, this, &GriffionGUI::gotoHistoryPage);
#endif // ENABLE_WALLET
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Griffion addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message…"), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Griffion addresses"));
    m_load_psbt_action = new QAction(tr("&Load PSBT from file…"), this);
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed Griffion Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from &clipboard…"), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed Griffion Transaction from clipboard"));
    ...
    openAction->setStatusTip(tr("Open a griffion: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Griffion command-line options").arg(PACKAGE_NAME));
    ...
    connect(quitAction, &QAction::triggered, this, &GriffionGUI::quitRequested);
    connect(aboutAction, &QAction::triggered, this, &GriffionGUI::aboutClicked);
    connect(aboutQtAction, &QAction::triggered, qApp, QApplication::aboutQt);
    connect(optionsAction, &QAction::triggered, this, &GriffionGUI::optionsClicked);
    connect(showHelpMessageAction, &QAction::triggered, this, &GriffionGUI::showHelpMessageClicked);
    connect(openRPCConsoleAction, &QAction::triggered, this, &GriffionGUI::showDebugWindow);
    ...
    if(walletFrame)
    {
        ...
        connect(openAction, &QAction::triggered, this, &GriffionGUI::openClicked);
        connect(m_open_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const std::pair<const std::string, bool>& i : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, path] {
                    ...
                    connect(activity, &OpenWalletActivity::opened, this, &GriffionGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_restore_wallet_action, &QAction::triggered, [this] {
            ...
            connect(activity, &RestoreWalletActivity::restored, this, &GriffionGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_create_wallet_action, &QAction::triggered, this, &GriffionGUI::createWallet);
        connect(m_close_all_wallets_action, &QAction::triggered, [this] {
            m_wallet_controller->closeAllWallets(this);
        });
        connect(m_migrate_wallet_action, &QAction::triggered, [this] {
            auto activity = new MigrateWalletActivity(m_wallet_controller, this);
            connect(activity, &MigrateWalletActivity::migrated, this, &GriffionGUI::setCurrentWallet);
            activity->migrate(walletFrame->currentWalletModel());
        });
        connect(m_mask_values_action, &QAction::toggled, this, &GriffionGUI::setPrivacy);
        connect(m_mask_values_action, &QAction::toggled, this, &GriffionGUI::enableHistoryAction);
    }
#endif // ENABLE_WALLET

    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_C), this), &QShortcut::activated, this, &GriffionGUI::showDebugWindowActivateConsole);
    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_D), this), &QShortcut::activated, this, &GriffionGUI::showDebugWindow);
}

void GriffionGUI::createMenuBar()
{
    appMenuBar = menuBar();
...
void GriffionGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        connect(m_wallet_selector, qOverload<int>(&QComboBox::currentIndexChanged), this, &GriffionGUI::setCurrentWalletBySelectorIndex);

        m_wallet_selector_label = new QLabel();
        m_wallet_selector_label->setBuddy(m_wallet_selector);

        m_wallet_selector->setStyleSheet(
            "QComboBox {"
            "    font-size: 14px;"
            "    color: #80000b;"
            "    border-radius: 0px;"
            ...
            "    selection-background-color: #80000b;"
...
void GriffionGUI::setClientModel(ClientModel *_clientModel, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    if(_clientModel)
    {
        ...
        connect(_clientModel, &ClientModel::numConnectionsChanged, this, &GriffionGUI::setNumConnections);
        connect(_clientModel, &ClientModel::networkActiveChanged, this, &GriffionGUI::setNetworkActive);
        ...
        connect(_clientModel, &ClientModel::numBlocksChanged, this, &GriffionGUI::setNumBlocks);
        ...
        connect(_clientModel, &ClientModel::showProgress, this, &GriffionGUI::showProgress);
...
#ifdef ENABLE_WALLET
void GriffionGUI::enableHistoryAction(bool privacy)
{
...
void GriffionGUI::setWalletController(WalletController* wallet_controller, bool show_loading_minimized)
{
    ...
    GUIUtil::ExceptionSafeConnect(wallet_controller, &WalletController::walletAdded, this, &GriffionGUI::addWallet);
    connect(wallet_controller, &WalletController::walletRemoved, this, &GriffionGUI::removeWallet);
...
WalletController* GriffionGUI::getWalletController()
{
    return m_wallet_controller;
}

void GriffionGUI::addWallet(WalletModel* walletModel)
{
    ...
    connect(wallet_view, &WalletView::outOfSyncWarningClicked, this, &GriffionGUI::showModalOverlay);
    connect(wallet_view, &WalletView::transactionClicked, this, &GriffionGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::coinsSent, this, &GriffionGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        this->message(title, message, style);
    });
    connect(wallet_view, &WalletView::encryptionStatusChanged, this, &GriffionGUI::updateWalletStatus);
    connect(wallet_view, &WalletView::incomingTransaction, this, &GriffionGUI::incomingTransaction);
    connect(this, &GriffionGUI::setPrivacy, wallet_view, &WalletView::setPrivacy);
...
void GriffionGUI::removeWallet(WalletModel* walletModel)
{
...
void GriffionGUI::setCurrentWallet(WalletModel* wallet_model)
{
    if (!walletFrame || !m_wallet_controller) return;
...
void GriffionGUI::setCurrentWalletBySelectorIndex(int index)
{
    WalletModel* wallet_model = m_wallet_selector->itemData(index).value<WalletModel*>();
    if (wallet_model) setCurrentWallet(wallet_model);
}

void GriffionGUI::removeAllWallets()
{
    if(!walletFrame)
        return;
    setWalletActionsEnabled(false);
...
void GriffionGUI::setWalletActionsEnabled(bool enabled)
{
...
void GriffionGUI::createTrayIcon()
{
...
void GriffionGUI::createTrayIconMenu()
{
#ifndef Q_OS_MACOS
    if (!trayIcon) return;
#endif // Q_OS_MACOS
    ...
    show_hide_action = trayIconMenu->addAction(QString(), this, &GriffionGUI::toggleHidden);
...
void GriffionGUI::optionsClicked()
{
    openOptionsDialogWithTab(OptionsDialog::TAB_MAIN);
}

void GriffionGUI::aboutClicked()
{
    if(!clientModel)
        return;
...
void GriffionGUI::showDebugWindow()
{
    GUIUtil::bringToFront(rpcConsole);
    Q_EMIT consoleShown(rpcConsole);
}

void GriffionGUI::showDebugWindowActivateConsole()
{
    rpcConsole->setTabFocus(RPCConsole::TabTypes::CONSOLE);
    showDebugWindow();
}

void GriffionGUI::showHelpMessageClicked()
{
    GUIUtil::bringToFront(helpMessageDialog);
}

#ifdef ENABLE_WALLET
void GriffionGUI::openClicked()
{
...
void GriffionGUI::gotoOverviewPage()
{
    overviewAction->setChecked(true);
    if (walletFrame) walletFrame->gotoOverviewPage();
}

void GriffionGUI::gotoHistoryPage()
{
    historyAction->setChecked(true);
    if (walletFrame) walletFrame->gotoHistoryPage();
}

void GriffionGUI::gotoReceiveCoinsPage()
{
    receiveCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoReceiveCoinsPage();
}

void GriffionGUI::gotoSendCoinsPage(QString addr)
{
    sendCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoSendCoinsPage(addr);
}

void GriffionGUI::gotoSignMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoSignMessageTab(addr);
}

void GriffionGUI::gotoVerifyMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoVerifyMessageTab(addr);
}
void GriffionGUI::gotoLoadPSBT(bool from_clipboard)
{
    if (walletFrame) walletFrame->gotoLoadPSBT(from_clipboard);
}
#endif // ENABLE_WALLET

void GriffionGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to Griffion network.", "", count);
    } else {
        //: A substring of the tooltip.
...
void GriffionGUI::setNumConnections(int count)
{
    updateNetworkState();
}

void GriffionGUI::setNetworkActive(bool network_active)
{
    updateNetworkState();
...
void GriffionGUI::updateHeadersSyncProgressLabel()
{
...
void GriffionGUI::updateHeadersPresyncProgressLabel(int64_t height, const QDateTime& blockDate)
{
...
void GriffionGUI::openOptionsDialogWithTab(OptionsDialog::Tab tab)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;

    auto dlg = new OptionsDialog(this, enableWallet);
    connect(dlg, &OptionsDialog::quitOnReset, this, &GriffionGUI::quitRequested);
...
void GriffionGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, SyncType synctype, SynchronizationState sync_state)
{
...
void GriffionGUI::createWallet()
{
    ...
    connect(activity, &CreateWalletActivity::created, this, &GriffionGUI::setCurrentWallet);
    connect(activity, &CreateWalletActivity::created, rpcConsole, &RPCConsole::setCurrentWallet);
    activity->create();
#endif // ENABLE_WALLET
}

void GriffionGUI::message(const QString& title, QString message, unsigned int style, bool* ret, const QString& detailed_message)
{
...
void GriffionGUI::changeEvent(QEvent *e)
{
    ...
    if(e->type() == QEvent::WindowStateChange)
    {
        if(clientModel && clientModel->getOptionsModel() && clientModel->getOptionsModel()->getMinimizeToTray())
        {
            ...
            {
                QTimer::singleShot(0, this, &GriffionGUI::hide);
                e->ignore();
            }
            else if((wsevt->oldState() & Qt::WindowMinimized) && !isMinimized())
            {
                QTimer::singleShot(0, this, &GriffionGUI::show);
                e->ignore();
            }
        }
    }
...
void GriffionGUI::closeEvent(QCloseEvent *event)
{
#ifndef Q_OS_MACOS // Ignored on Mac
    if(clientModel && clientModel->getOptionsModel())
    {
...
void GriffionGUI::showEvent(QShowEvent *event)
{
...
#ifdef ENABLE_WALLET
void GriffionGUI::incomingTransaction(const QString& date, GriffionUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName)
{
    // On new transaction, make an info balloon
    QString msg = tr("Date: %1\n").arg(date) +
                  tr("Amount: %1\n").arg(GriffionUnits::formatWithUnit(unit, amount, true));
...
void GriffionGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void GriffionGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
...
bool GriffionGUI::eventFilter(QObject *object, QEvent *event)
{
...
#ifdef ENABLE_WALLET
bool GriffionGUI::handlePaymentRequest(const SendCoinsRecipient& recipient)
{
    // URI has to be valid
...
void GriffionGUI::setHDStatus(bool privkeyDisabled, int hdEnabled)
{
...
void GriffionGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void GriffionGUI::updateWalletStatus()
{
    assert(walletFrame);
...
void GriffionGUI::updateProxyIcon()
{
    std::string ip_port;
...
void GriffionGUI::updateWindowTitle()
{
...
void GriffionGUI::showNormalIfMinimized(bool fToggleHidden)
{
    if(!clientModel)
        return;
...
void GriffionGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void GriffionGUI::detectShutdown()
{
...
void GriffionGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0) {
...
void GriffionGUI::showModalOverlay()
{
    if (modalOverlay && (progressBar->isVisible() || modalOverlay->isLayerVisible()))
        modalOverlay->toggleVisibility();
}

static bool ThreadSafeMessageBox(GriffionGUI* gui, const bilingual_str& message, const std::string& caption, unsigned int style)
{
    ...
    if (message.original != message.translated) {
        detailed_message = GriffionGUI::tr("Original message:") + "\n" + QString::fromStdString(message.original);
    }
...
void GriffionGUI::subscribeToCoreSignals()
{
...
void GriffionGUI::unsubscribeFromCoreSignals()
{
...
bool GriffionGUI::isPrivacyModeActivated() const
{
    ...
    : m_platform_style{platformStyle}
{
    ...
    QList<GriffionUnit> units = GriffionUnits::availableUnits();
    int max_width = 0;
    const QFontMetrics fm(font());
    for (const GriffionUnit unit : units) {
        max_width = qMax(max_width, GUIUtil::TextWidth(fm, GriffionUnits::longName(unit)));
    }
...
{
    menu = new QMenu(this);
    for (const GriffionUnit u : GriffionUnits::availableUnits()) {
        menu->addAction(GriffionUnits::longName(u))->setData(QVariant::fromValue(u));
    }
...
void UnitDisplayStatusBarControl::updateDisplayUnit(GriffionUnit newUnits)
{
    setText(GriffionUnits::longName(newUnits));
}
