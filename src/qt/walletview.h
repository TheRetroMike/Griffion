...
#ifndef GRIFFION_QT_WALLETVIEW_H
#define GRIFFION_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a griffion wallet, and offers access to
...
#endif // GRIFFION_QT_WALLETVIEW_H
