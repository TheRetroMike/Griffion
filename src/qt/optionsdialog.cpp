      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->griffionAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->griffionAtStartup);
    ...
    ui->griffionAtStartup->setToolTip(ui->griffionAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->griffionAtStartup->setText(ui->griffionAtStartup->text().arg(PACKAGE_NAME));

    ui->openGriffionConfButton->setToolTip(ui->openGriffionConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new GriffionUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->griffionAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSGRIFFontrols);
...
void OptionsDialog::on_openGriffionConfButton_clicked()
{
