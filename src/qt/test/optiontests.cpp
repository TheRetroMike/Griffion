...
{
    // Test regression https://github.com/GriffionProject/Griffion/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/griffion-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/griffion-core/gui/pull/568.
    // With fListen=false in ~/.config/Griffion/Griffion-Qt.conf and all else left as default,
    // griffion-qt should set both -listen and -listenonion to false and start successfully.
