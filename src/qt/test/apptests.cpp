...
//! Entry point for GriffionApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &GriffionApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for GriffionGUI tests.
void AppTests::guiTests(GriffionGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &GriffionGUI::consoleShown, this, &AppTests::consoleTests);
