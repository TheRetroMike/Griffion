...
#ifndef GRIFFION_QT_OPTIONSMODEL_H
#define GRIFFION_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Griffion client.
...
public:
    ...
    GriffionUnit getDisplayUnit() const { return m_display_griffion_unit; }
...
private:
    ...
    QString language;
    GriffionUnit m_display_griffion_unit;
...
Q_SIGNALS:
    void displayUnitChanged(GriffionUnit unit);
...
#endif // GRIFFION_QT_OPTIONSMODEL_H
