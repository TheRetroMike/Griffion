...
#ifndef GRIFFION_QT_SENDCOINSENTRY_H
#define GRIFFION_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending Griffion.
 */
...
#endif // GRIFFION_QT_SENDCOINSENTRY_H
