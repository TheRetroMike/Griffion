...
#ifndef GRIFFION_QT_GUIUTIL_H
#define GRIFFION_QT_GUIUTIL_H
...
/** Utility functions used by the Griffion Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "griffion:" URI into recipient object, return true on successful parsing
