...
#ifndef GRIFFION_QT_GRIFFIONGUI_H
#define GRIFFION_QT_GRIFFIONGUI_H
...
/**
  Griffion GUI main class. This class represents the main window of the Griffion UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class GriffionGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit GriffionGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~GriffionGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a griffion wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, GriffionUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Griffion Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(GriffionUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // GRIFFION_QT_GRIFFIONGUI_H
