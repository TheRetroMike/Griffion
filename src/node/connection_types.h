...
#ifndef GRIFFION_NODE_CONNECTION_TYPES_H
#define GRIFFION_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/griffion-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Griffion’s Peer-to-Peer Network")
...
#endif // GRIFFION_NODE_CONNECTION_TYPES_H
