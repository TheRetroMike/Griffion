...
#ifndef GRIFFION_INTERFACES_NODE_H
#define GRIFFION_INTERFACES_NODE_H
...
//! Top-level interface for a griffion node (griffiond process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or griffion.conf.
...
#endif // GRIFFION_INTERFACES_NODE_H
