...
#ifndef GRIFFION_INTERFACES_INIT_H
#define GRIFFION_INTERFACES_INIT_H
...
//! (griffion-gui, griffion-node, griffion-wallet, griffiond, griffion-qt) and each
...
#endif // GRIFFION_INTERFACES_INIT_H
