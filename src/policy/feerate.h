...
#ifndef GRIFFION_POLICY_FEERATE_H
#define GRIFFION_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "GRIFF"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    GRIFF_KVB,      //!< Use GRIFF/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::GRIFF_KVB) const;
...
#endif // GRIFFION_POLICY_FEERATE_H
