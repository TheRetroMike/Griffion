...
#ifndef GRIFFION_TEST_SCRIPTNUM10_H
#define GRIFFION_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Griffion Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // GRIFFION_TEST_SCRIPTNUM10_H
