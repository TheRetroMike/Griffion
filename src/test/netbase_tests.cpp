...
{
    BOOST_CHECK(TestSplitHost("www.griffion.org", "www.griffion.org", 0));
    BOOST_CHECK(TestSplitHost("[www.griffion.org]", "www.griffion.org", 0));
    BOOST_CHECK(TestSplitHost("www.griffion.org:80", "www.griffion.org", 80));
    BOOST_CHECK(TestSplitHost("[www.griffion.org]:80", "www.griffion.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:4710", "127.0.0.1", 4710));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:4710", "127.0.0.1", 4710));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:4710", "::ffff:127.0.0.1", 4710));
    BOOST_CHECK(TestSplitHost("[::]:4710", "::", 4710));
    BOOST_CHECK(TestSplitHost("::4710", "::4710", 0));
    BOOST_CHECK(TestSplitHost(":4710", "", 4710));
    BOOST_CHECK(TestSplitHost("[]:4710", "", 4710));
    ...
    BOOST_CHECK(TestSplitHost("www.griffion.org:65536", "www.griffion.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.griffion.org:0", "www.griffion.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.griffion.org:", "www.griffion.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:4710", "127.0.0.1:4710"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:4710", "[::]:4710"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
