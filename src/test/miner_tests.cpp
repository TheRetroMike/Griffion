...
constexpr static struct {
    ...
    unsigned int nonce;
} BLOCKINFO[]{{0xc6, 0x03114}, {0xfe, 0x0358b}, {0x19, 0x02d46}, {0x60, 0x00623}, {0x6b, 0x007d6}, {0x2b, 0x00bcf}, {0x8d, 0x002cc}, {0x28, 0x00043}, {0xc7, 0x01822}, {0xd8, 0x00b12}, 
              {0x2a, 0x02592}, {0x55, 0x0021c}, {0x21, 0x00059}, {0x64, 0x02a95}, {0xd5, 0x012f0}, {0x95, 0x0172c}, {0x22, 0x026b9}, {0x95, 0x03f9a}, {0xd0, 0x007f2}, {0x2b, 0x01696}, 
              {0xca, 0x00256}, {0xbe, 0x0141e}, {0xc6, 0x0082f}, {0xa3, 0x03e60}, {0xc9, 0x01bc7}, {0x52, 0x00809}, {0xa4, 0x00310}, {0x5a, 0x0156f}, {0x47, 0x002ef}, {0x71, 0x00d37}, 
              {0x24, 0x003ce}, {0xea, 0x00310}, {0x28, 0x0229c}, {0x72, 0x0091d}, {0x89, 0x034ed}, {0xa2, 0x01a9b}, {0xc5, 0x01fd3}, {0x7e, 0x01387}, {0x46, 0x001cd}, {0x39, 0x00ee0}, 
              {0x3d, 0x012f8}, {0x1f, 0x030cf}, {0xdf, 0x02747}, {0xc2, 0x0114a}, {0x34, 0x01279}, {0xe7, 0x006c8}, {0xd3, 0x0071f}, {0xee, 0x03fb1}, {0xab, 0x00a02}, {0x7b, 0x01326}, 
              {0x5e, 0x016de}, {0xa6, 0x00860}, {0x38, 0x00d79}, {0xce, 0x02763}, {0x1c, 0x015e8}, {0x32, 0x03234}, {0xaa, 0x015ae}, {0x2b, 0x00696}, {0x5b, 0x02b6d}, {0x2f, 0x0156f}, 
              {0xad, 0x0125c}, {0x46, 0x0a0d4}, {0xe9, 0x08422}, {0x2b, 0x013ea}, {0xd7, 0x05553}, {0xd0, 0x01a99}, {0x56, 0x036e4}, {0x3d, 0x06f49}, {0x6e, 0x00aff}, {0xe0, 0x01938}, 
              {0xa1, 0x05fb5}, {0x5b, 0x0033c}, {0x1c, 0x029f5}, {0xf7, 0x0039f}, {0xec, 0x01140}, {0x6d, 0x0249b}, {0x22, 0x0167a}, {0x28, 0x0291b}, {0x7e, 0x009fd}, {0x71, 0x00244}, 
              {0x3b, 0x011cd}, {0xdb, 0x01d46}, {0xe2, 0x008c6}, {0x1a, 0x02d4e}, {0x10, 0x0042c}, {0x6e, 0x011d5}, {0xc4, 0x00cbd}, {0x7e, 0x01f38}, {0x1e, 0x01280}, {0x16, 0x00c3e}, 
              {0x55, 0x01376}, {0x84, 0x00c13}, {0x72, 0x01d73}, {0xc3, 0x042b8}, {0xfd, 0x02c07}, {0x27, 0x02319}, {0xf1, 0x0101b}, {0x47, 0x01924}, {0xa3, 0x0191f}, {0x53, 0x00097}, 
              {0xce, 0x00e45}, {0x53, 0x02d50}, {0x88, 0x02180}, {0xae, 0x0212c}, {0xf3, 0x0273c}, {0x33, 0x007c1}, {0x64, 0x00c62}, {0x27, 0x00a6f}, {0xd3, 0x03f34}, {0x13, 0x0039e}};
...
void MinerTestingSetup::TestPackageSelection(const CScript& scriptPubKey, const std::vector<CTransactionRef>& txFirst)
{
    ...
    tx.vout[1].nValue = 100000000; // 1GRIFF output
...
BOOST_AUTO_TEST_CASE(CreateNewBlock_validity)
{
    ...
    CScript scriptPubKey = CScript() << ParseHex("76a9140160d400545e14a1de78e255c4f3dbe90da649bf88ac") << OP_CHECKSIG;
    std::unique_ptr<CBlockTemplate> pblocktemplate;
