...
BOOST_AUTO_TEST_CASE(test_LocaleIndependentAtoi)
{
    ...
    // Ensure legacy compatibility with previous versions of Griffion Core's atoi64
    for (const auto& pair : atoi64_test_pairs) {
...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("griffion"), "Griffion");
...
BOOST_AUTO_TEST_CASE(message_sign)
{
    const std::array<unsigned char, 32> privkey_bytes = {
        ...
        // derived address from this private key: GQ7UTELd9soWKsj8c9YT1xD4ifPZ5PBpqA
        0x59, 0xD6, 0xA4, 0xFB, 0x2A, 0x34, 0xB6, 0x91,
        0x2F, 0x1A, 0x35, 0x5C, 0x6D, 0x51, 0x25, 0x15,
        0xF7, 0x7F, 0xB6, 0xA7, 0xA6, 0x75, 0xAA, 0xD4,
        0xF7, 0x59, 0x1B, 0x2E, 0x29, 0xEA, 0x21, 0x72
    };

    const std::string message = "Trust no one";

    const std::string expected_signature =
        "IN1O8y3PtqaeYR1gG7QDLkF1YctOlrjzPeaJXbVRe2O9MAWKJqYP3n68SvBsdyUIHJa+PolH3cUWr7YD6PU6+ss=";
...
BOOST_AUTO_TEST_CASE(message_verify)
{
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "XS1vNj8Sfw9NCXHegdoAhbQikx63Kun6LY",
            "signature should be irrelevant",
            "message too"),
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "GHxDkuUXzRYs1sjjZrm6uZrM83EeQsa3rE",
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "GHxDkuUXzRYs1sjjZrm6uZrM83EeQsa3rE",
            "H8ObBDNEUbr2mpaisM6Xx+AxCO2IE1LkcAd7YVtCQffMIN8RSk7IcwQjGsaIL64qFajh211Qq3ZRwYGxY7OoTZg=",
            "Trust no one"),
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "GHxDkuUXzRYs1sjjZrm6uZrM83EeQsa3rE",
            "ILXXnSqAWUlYgj29VGFWGiitmsLF+fce8Dt4zoiMggZDYA6FW4v3yCnOHi1p1vJYIRlYjzcK1y5R5tF7Idf9h/s=",
            "Trust me"),
        MessageVerificationResult::OK);
}
...
BOOST_AUTO_TEST_CASE(util_WriteBinaryFile)
{
    ...
    std::string expected_text = "griffion";
