...
// amounts 1 .. 10000
#define NUM_MULTIPLES_1GRIFF 10000

// amounts 50 .. 11000000000
#define NUM_MULTIPLES_50GRIFF 420000
...
BOOST_AUTO_TEST_CASE(compress_amounts)
{
    ...
    BOOST_CHECK(TestPair(11000000000*COIN,    0x28FA6AE00));
    ...
    for (uint64_t i = 1; i <= NUM_MULTIPLES_1GRIFF; i++)
        BOOST_CHECK(TestEncode(i * COIN));

    for (uint64_t i = 1; i <= NUM_MULTIPLES_50GRIFF; i++)
