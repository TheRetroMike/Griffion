...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As Griffion relies on 80 byte header hashes, we want to have an example for that.",
               "1962b56f7b30cc858c4ae767c0311f7dec46ad84be3f686e266213642f9e84a0");
