...
"""
Test starting griffiond with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(GriffionTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that griffiond has bound on "::1" (for RPC) and "::" (for P2P).
