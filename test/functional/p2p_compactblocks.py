...
# TestP2PConn: A peer we use to send messages to griffiond, and store responses.
...
class CompactBlocksTest(GriffionTestFramework):
    ...
    # This test actually causes griffiond to (reasonably!) disconnect us, so do this last.
    ...
    # Test that griffiond requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for griffiond to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # griffiond will not send blocktxn responses for blocks whose height is
