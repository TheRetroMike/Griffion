...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/GriffionProject/Griffion/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(GriffionTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our griffiond node")
