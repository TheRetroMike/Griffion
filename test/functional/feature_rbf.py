...
class ReplaceByFeeTest(GriffionTestFramework):
    ...
    def test_doublespend_chain(self):
        ...
        # child fees - 4 GRIFF - so this attempt is rejected.
    ...
    def test_rpc(self):
        ...
        ins = [us0]
        outs = {ADDRESS_TRF1_UNSPENDABLE: Decimal(1.0000000)}
