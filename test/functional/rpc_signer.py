...
Verify that a griffiond node can use an external signer command.
...
class RPCSignerTest(GriffionTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart griffiond with -signer=<cmd>',
