...
to a hash that has been compiled into griffiond.
...
class AssumeutxoTest(GriffionTestFramework):
    ...
    def test_invalid_mempool_state(self, dump_output_path):
        self.log.info("Test griffiond should fail when mempool not empty.")
        node=self.nodes[2]
