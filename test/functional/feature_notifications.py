...
from test_framework.address import ADDRESS_TRF1_UNSPENDABLE
...
class NotificationsTest(GriffionTestFramework):
    ...
    def run_test(self):
        ...
        block_count = 10
        blocks = self.generatetoaddress(self.nodes[1], block_count, self.nodes[1].getnewaddress() if self.is_wallet_compiled() else ADDRESS_TRF1_UNSPENDABLE)
        ...
        if self.is_wallet_compiled():
            ...
            self.generatetoaddress(self.nodes[0], 100, ADDRESS_TRF1_UNSPENDABLE)

            # Generate transaction on node 0, sync mempools, and check for
            # notification on node 1.
            tx1 = self.nodes[0].sendtoaddress(address=ADDRESS_TRF1_UNSPENDABLE, amount=1, replaceable=True)
            ...
            # https://github.com/GriffionProject/Griffion/pull/9371, it might be better
            ...
            blockhash1 = self.generatetoaddress(self.nodes[0], 1, ADDRESS_TRF1_UNSPENDABLE)[0]
            ...
            tx2 = self.nodes[0].sendtoaddress(address=ADDRESS_TRF1_UNSPENDABLE, amount=1, replaceable=True)
            ...
            blockhash2 = self.generatetoaddress(self.nodes[0], 1, ADDRESS_TRF1_UNSPENDABLE, sync_fun=self.no_op)[0]
