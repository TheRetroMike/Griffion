...
By default, griffiond will dump mempool on shutdown and
...
class MempoolPersistTest(GriffionTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent griffiond from writing mempool.dat to disk. Verify that `savemempool` fails")
