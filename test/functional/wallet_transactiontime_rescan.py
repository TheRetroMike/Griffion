...
class TransactionTimeRescanTest(GriffionTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine GRIFF and create transactions
        ...
        # generate some griff to create transactions and check blockcount
        ...
        # send 10 griff to user's first watch-only address
        self.log.info('Send 10 griff to user')
        ...
        # send 5 griff to our second watch-only address
        self.log.info('Send 5 griff to user')
        ...
        # send 1 griff to our third watch-only address
        self.log.info('Send 1 griff to user')
