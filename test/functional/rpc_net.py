...
class NetTest(GriffionTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=4710)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 4710)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=4710), {"success": False})
