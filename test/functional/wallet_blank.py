...
from test_framework.address import (
    ...
    ADDRESS_TRF1_UNSPENDABLE_DESCRIPTOR,
)
...
class WalletBlankTest(GriffionTestFramework):
    ...
    def test_importaddress(self):
        ...
        wallet.importaddress(ADDRESS_TRF1_UNSPENDABLE)
    ...
    def test_importmulti(self):
        ...
        assert_equal(info["blank"], True)
        wallet.importmulti([{
            "desc": ADDRESS_TRF1_UNSPENDABLE_DESCRIPTOR,
            "timestamp": "now",
        }])
        assert_equal(wallet.getwalletinfo()["blank"], False)
