...
class TxnMallTest(GriffionTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 GRIFF:
        ...
        # First: use raw transaction API to send 1240 GRIFF to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 GRIFF coin each
        ...
        # Node0's balance should be starting balance, plus 50GRIFF for another
        ...
        # Node0's total balance should be starting balance, plus 100GRIFF for
