...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the GriffionTestFramework
    pass


class ExampleTest(GriffionTestFramework):
    # Each functional test is a subclass of the GriffionTestFramework class.
    ...
    def custom_method(self):
        ...
        GriffionTestFramework class so other tests can use it."""
