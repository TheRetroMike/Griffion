...
from test_framework.address import ADDRESS_TRF1_UNSPENDABLE as ADDRESS_WATCHONLY
...
class WalletTest(GriffionTestFramework):
    ...
    def run_test(self):
        ...
        # Send 40 GRIFF from 0 to 1 and 60 GRIFF from 1 to 0.
        ...
        # GRIFF, which is more than would be available if transaction 1 were
        # replaced.
