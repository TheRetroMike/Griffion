...
"""  Tests the mempool:* tracepoint API interface.
     See https://github.com/GriffionProject/Griffion/blob/master/doc/tracing.md#context-mempool
"""
...
class MempoolTracepointTest(GriffionTestFramework):
    ...
    def rejected_test(self):
        ...
        # https://github.com/GriffionProject/Griffion/issues/27380
