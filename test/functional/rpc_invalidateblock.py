...
from test_framework.address import ADDRESS_TRF1_UNSPENDABLE_DESCRIPTOR
...
class InvalidateTest(GriffionTestFramework):
    ...
    def run_test(self):
        ...
        blocks = self.generatetodescriptor(self.nodes[1], 10, ADDRESS_TRF1_UNSPENDABLE_DESCRIPTOR, sync_fun=self.no_op)
