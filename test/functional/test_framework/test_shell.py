...
class TestShell:
    """Wrapper Class for GriffionTestFramework.

    The TestShell class extends the GriffionTestFramework
    ...
    class __TestShell(GriffionTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by GriffionTestFramework child class.
            self.num_nodes = 1
