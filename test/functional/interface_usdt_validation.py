...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/GriffionProject/Griffion/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(GriffionTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/GriffionProject/Griffion/blob/master/doc/tracing.md#tracepoint-validationblock_connected
        ...
        block_hashes = self.generatetoaddress(
            self.nodes[0], BLOCKS_EXPECTED, ADDRESS_TRF1_UNSPENDABLE)
