...
from test_framework.address import (
    ADDRESS_TRF1_P2WSH_OP_TRUE,
    ADDRESS_TRF1_UNSPENDABLE,
)
...
class ZMQTest (GriffionTestFramework):
    ...
    def test_basic(self):
        ...
        genhashes = self.generatetoaddress(self.nodes[0], num_blocks, ADDRESS_TRF1_UNSPENDABLE)
        ...
        self.generatetoaddress(self.nodes[0], 1, ADDRESS_TRF1_UNSPENDABLE)
        hashtx.receive()
        txid = hashtx.receive()
        assert_equal(payment_txid, txid.hex())
    ...
    def test_reorg(self):
        ...
        disconnect_block = self.generatetoaddress(self.nodes[0], 1, ADDRESS_TRF1_UNSPENDABLE, sync_fun=self.no_op)[0]
        ...
        connect_blocks = self.generatetoaddress(self.nodes[1], 2, ADDRESS_TRF1_P2WSH_OP_TRUE, sync_fun=self.no_op)
    ...
    def test_sequence(self):
        ...
        dc_block = self.generatetoaddress(self.nodes[0], 1, ADDRESS_TRF1_UNSPENDABLE, sync_fun=self.no_op)[0]

        # Note: We are not notified of any block transactions, coinbase or mined
        assert_equal((self.nodes[0].getbestblockhash(), "C", None), seq.receive_sequence())

        # Generate 2 blocks in nodes[1] to a different address to ensure a chain split
        self.generatetoaddress(self.nodes[1], 2, ADDRESS_TRF1_P2WSH_OP_TRUE, sync_fun=self.no_op)
        ...
        c_block = self.generatetoaddress(self.nodes[0], 1, ADDRESS_TRF1_UNSPENDABLE)[0]
        ...
        self.generatetoaddress(self.nodes[1], 1, ADDRESS_TRF1_UNSPENDABLE)
    ...
    def test_multiple_interfaces(self):
        ...
        # Generate 1 block in nodes[0] and receive all notifications
        self.generatetoaddress(self.nodes[0], 1, ADDRESS_TRF1_UNSPENDABLE, sync_fun=self.no_op)
