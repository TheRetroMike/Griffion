...
"""Verify that starting griffion with -h works as expected."""

from test_framework.test_framework import GriffionTestFramework
from test_framework.util import assert_equal

class HelpTest(GriffionTestFramework):
    ...
    def run_test(self):
        self.log.info("Start griffion with -h for help text")
        ...
        self.log.info("Start griffion with -version for version information")
        ...
        self.log.info("Start griffiond with -fakearg to make sure it does not start")
