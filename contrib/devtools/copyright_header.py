...
EXPECTED_HOLDER_NAMES = [
    r"Satoshi Nakamoto",
    r"The Griffion Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a griffion source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Griffion Core developers'
...
Arguments:
    <file> - A source file in the griffion repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Griffion
