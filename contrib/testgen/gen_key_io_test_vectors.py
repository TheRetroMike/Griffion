...
bech32_templates = [
  ...
  ('grf',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('grf',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('grf',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('grf',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('trf',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('trf',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('trf',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('trf',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('trf',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('trf',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('trf',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('trf', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('trf',   17, 32, Encoding.BECH32M, False, False, False),
  ('trf',  3,  1, Encoding.BECH32M, False, False, False),
  ('grf',   15, 41, Encoding.BECH32M, False, False, False),
  ('trf',    0, 16, Encoding.BECH32,  False, False, False),
  ('trf',  0, 32, Encoding.BECH32,  True,  False, False),
  ('grf',    0, 16, Encoding.BECH32,  True,  False, False),
  ('trf',    0, 32, Encoding.BECH32,  False, True,  False),
  ('trf',  0, 20, Encoding.BECH32,  False, False, True),
  ('grf',    0, 20, Encoding.BECH32M, False, False, False),
  ('trf',    0, 32, Encoding.BECH32M, False, False, False),
  ('trf',  0, 20, Encoding.BECH32M, False, False, False),
  ('grf',    1, 32, Encoding.BECH32,  False, False, False),
  ('trf',    2, 16, Encoding.BECH32,  False, False, False),
  ('trf', 16, 20, Encoding.BECH32,  False, False, False),
]
