...
(define* (make-griffion-cross-toolchain target
                                       #:key
...
desirable for building Griffion Core release binaries."
...
;; failure; see https://github.com/GriffionProject/Griffion/pull/27296.
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-griffion-cross-toolchain target)))
