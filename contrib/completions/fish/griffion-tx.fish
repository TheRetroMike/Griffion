...
# Extract options
function __fish_griffion_tx_get_options
...
# Extract commands
function __fish_griffion_tx_get_commands
...
complete \
    --command griffion-tx \
    --condition "not __fish_griffion_seen_cmd (__fish_griffion_tx_get_commands --commandsonly)" \
    --arguments "(__fish_griffion_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command griffion-tx \
    --arguments "(__fish_griffion_tx_get_commands)" \
    --no-files
