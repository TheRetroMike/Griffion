...
complete --command griffiond --no-files

# Extract options
function __fish_griffiond_get_options
...
complete \
    --command griffiond \
    --arguments "(__fish_griffiond_get_options --nofiles)"
