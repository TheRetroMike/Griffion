...
complete --command griffion-qt --no-files

# Extract options
function __fish_griffionqt_get_options
...
complete \
    --command griffion-qt \
    --arguments "(__fish_griffionqt_get_options --nofiles)"
