...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef GRIFFION_CHAINPARAMSSEEDS_H\n')
    g.write('#define GRIFFION_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the griffion network\n')
    ...
    g.write('#endif // GRIFFION_CHAINPARAMSSEEDS_H\n')
