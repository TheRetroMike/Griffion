...
"""Example logging Griffion Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/griffiond
...
def main(griffiond_path):
    ...
    b = BPF(text=program, usdt_contexts=[griffiond_with_usdts])
