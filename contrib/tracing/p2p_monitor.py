...
""" Interactive griffiond P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Griffion Core can enable. It uses BCC
...
def main(griffiond_path):
    ...
    griffiond_with_usdts.enable_probe(
